...
test('structured facts enforce tenant access, canonical text, validation and re-verification', async () => {
  ...
  try {
    ...
    await db.query(
      readFileSync('supabase/migrations/20260921001800_company_source_capabilities.sql', 'utf8'),
    );
    await db.query(
      readFileSync('supabase/migrations/20260921002000_california_passport_catalog.sql', 'utf8'),
    );
