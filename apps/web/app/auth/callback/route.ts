...
import { signInRecoveryHref } from '../../../lib/sign-in-recovery';
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    // Never log the callback URL, token or provider exception.
  }
  return NextResponse.redirect(new URL(signInRecoveryHref(next), origin));
}
