...
export const companyTemplates: Record<string, CompanyTemplate> = {
  ...
  entity: {
    ...
    fields: [
      ...
      field('city', 'Headquarters city'),
      field('state', 'Headquarters state'),
  ...
  registration: {
    ...
    fields: [
      ...
      field('last_checked', 'Source last checked', 'date'),
    ],
  },
  uei_cage: {
    type: 'registration',
    ...
    fields: [
      field('uei', 'UEI'),
      field('cage', 'CAGE code'),
      field('entity', 'Registered entity'),
      field('sam_status', 'SAM status as claimed'),
      field('last_checked', 'Source last checked', 'date'),
    ],
  },
  license: {
  ...
  bonding: {
    ...
    fields: [
      ...
      field('single_band', 'Single-project bonding band as claimed'),
      field('aggregate_band', 'Aggregate bonding band as claimed'),
      field('bid_bond', 'Bid-bond capability as claimed'),
      field('aggregate_limit', 'Aggregate limit', 'amount'),
  ...
  project: {
    ...
    fields: [
      ...
      field('value_band', 'Project value band'),
      field('year', 'Project year'),
      field('location', 'Project location'),
      field('permission', 'Permission to disclose: yes / no / unknown'),
      field('currency', 'Currency', 'code'),
...
export function suggestedTemplate(type: string, label: string) {
  const aliases: Record<string, string> = {
    'CSLB license and classifications': 'license',
    'DIR public-works registration': 'registration',
    'SAM registration and UEI': 'uei_cage',
    'Bonding bands and bid-bond capability': 'bonding',
    'General liability insurance': 'insurance',
    'Workers’ compensation insurance': 'insurance',
    'Commercial auto insurance': 'insurance',
    'Past project 1': 'project',
    'Past project 2': 'project',
    'Past project 3': 'project',
