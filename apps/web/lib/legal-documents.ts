  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Unsaved conversations are held in the current tab’s memory. For a selected bid, you may explicitly save a private checkpoint containing up to eight recent exchanges and their supporting context. This encrypted database copy is bound to your account, organization, role and bid; it is not a shared team conversation. Saving again replaces the previous checkpoint. Resume access expires after 30 days and requires current record access and freshness checks. You can delete the saved copy; expired encrypted copies may remain until replaced or deleted. Clearing the open conversation does not delete a separately saved copy. Usage metadata, keyed prompt digests, feedback and security/audit records are handled separately.',
